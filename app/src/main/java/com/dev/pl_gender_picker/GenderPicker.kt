package com.dev.pl_gender_picker
...
fun GenderPicker(
    ...
    val malePath = remember {
        PathParser()
            .parsePathString(malePathString)
            .toPath()
    }
    val femalePath = remember {
        PathParser()
            .parsePathString(femalePathString)
            .toPath()
    }
            ...
            .pointerInput(true) {
                detectTapGestures {
                    ...
                    if(
                        ...
                        transformFemaleRect.contains(it)
                    ) {
                        currentClickOffset = it
